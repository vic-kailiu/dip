...
<html lang="en">
  ...
  <section id="container" >
   ...
   <!--header start-->
						...
						<div class="btn-group">
						  ...
						  <!-- After clicking Addition button -->
						   <div class="form-group" id="viewmodeladdition" style="display: none">
                              ...
                              <div class="col-sm-10">
								  <input type="radio" value =A1 name="optionmodel" id="additionA1" /><img id="modelA1" src="assets/img/portfolio/modelA1.png" style="display: none"/>
								  <input type="radio" value =A2 name="optionmodel" id="additionA2" /><img id="modelA2" src="assets/img/portfolio/modelA2.png" style="display: none"/>
                              </div>
                          </div>
						  ...
						  <div class="form-group" id="viewmodelsubtraction" style="display: none">
                              <label class="col-sm-2 col-sm-2 control-label">View of Model</label>
                              <div class="col-sm-10">
								  <input type="radio" value =S1 name="optionmodel" id="subtractionS1"/><img id="modelS1" src="assets/img/portfolio/modelS1.png" style="display: none"/>
								  <input type="radio" value =S2 name="optionmodel" id="subtractionS2"/><img id="modelS2" src="assets/img/portfolio/modelS2.png" style="display: none"/>
                              </div>
                          </div>
						  ...
						  <div class="form-group" id="viewmodelmultiplication" style="display: none">
                              <label class="col-sm-2 col-sm-2 control-label">View of Model</label>
                              <div class="col-sm-10">
								  <input type="radio" value =M1 name="optionmodel" id="multiplicationM1"/><img id="modelM1" src="assets/img/portfolio/modelM1.png" style="display: none"/>
                              </div>
                          </div>
						  ...
						  <div class="form-group" id="viewmodeldivision" style="display: none">
                              <label class="col-sm-2 col-sm-2 control-label">View of Model</label>
                              <div class="col-sm-10">
								  <input type="radio" value =D1 name="optionmodel" id="divisionD1"/><img id="modelD1" src="assets/img/portfolio/modelD1.png" style="display: none"/>
								  <input type="radio" value =D2 name="optionmodel" id="divisionD2"/><img id="modelD2" src="assets/img/portfolio/modelD2.png" style="display: none"/>
                              </div>
                          </div>
	...
	<script src="assets/js/newcontent.js"></script>
